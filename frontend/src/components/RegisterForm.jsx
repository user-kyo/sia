    ...
    <div className="w-full max-w-[400px]">
      ...
      <form className="space-y-6" onSubmit={handleRegister}>
        <div className="space-y-1.5">
          <label className={`block text-sm font-semibold ${error ? 'text-rose-500' : 'text-slate-700 dark:text-slate-300'}`} htmlFor="fullName">
            Full Name
          </label>
          <input
            id="fullName"
        ...
        <div className="space-y-1.5 relative z-20">
          <label className={`block text-sm font-semibold ${error ? 'text-rose-500' : 'text-slate-700 dark:text-slate-300'}`}>
            Role
          </label>
        ...
        <div className="space-y-1.5">
          <label className={`block text-sm font-semibold ${error ? 'text-rose-500' : 'text-slate-700 dark:text-slate-300'}`} htmlFor="confirmPassword">
            Confirm Password
          </label>
          <input
            id="confirmPassword"
