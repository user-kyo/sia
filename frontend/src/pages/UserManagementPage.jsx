                    ...
                    <tr key={`skel-${idx}`} className="h-[73px] bg-transparent border-b border-slate-100 dark:border-white/5 last:border-0 opacity-40">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-full bg-slate-200 dark:bg-white/10 shrink-0 animate-shimmer" />
                          <div className="h-4 w-24 bg-slate-200 dark:bg-white/10 rounded animate-shimmer" />
                        </div>
                      </td>
                      <td className="px-6 py-4"><div className="h-4 w-32 bg-slate-200 dark:bg-white/10 rounded animate-shimmer" /></td>
                      <td className="px-6 py-4"><div className="h-6 w-24 bg-slate-200 dark:bg-white/10 rounded-md animate-shimmer" /></td>
                      <td className="px-6 py-4"><div className="h-6 w-20 bg-slate-200 dark:bg-white/10 rounded-md animate-shimmer" /></td>
                      <td className="px-6 py-4"><div className="h-4 w-20 bg-slate-200 dark:bg-white/10 rounded animate-shimmer" /></td>
                      <td className="px-6 py-4"><div className="h-8 w-8 bg-slate-200 dark:bg-white/10 rounded-lg mx-auto animate-shimmer" /></td>
                    </tr>
                  ))}
                </motion.tbody>
              ) : (
